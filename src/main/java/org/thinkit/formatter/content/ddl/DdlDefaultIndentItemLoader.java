...
package org.thinkit.formatter.content.ddl;
...
/**
 * コンテンツ「DDL既定インデント項目」の情報をロードするコンテンツクラスです。
 *
 * @author Kato Shinya
 * @since 1.0
 * @version 1.0
...
@ToString
@EqualsAndHashCode
@ContentMapping(content = "formatter/sql/DdlDefaultIndentItem")
public final class DdlDefaultIndentItemLoader implements Content<DdlDefaultIndentItem> {

    /**
     * デフォルトコンストラクタ
     */
    private DdlDefaultIndentItemLoader() {
    }

    /**
     * {@link DdlDefaultIndentItemLoader} クラスの新しいインスタンスを生成し返却します。
     *
     * @return {@link DdlDefaultIndentItemLoader} クラスの新しいインスタンス
     */
    public static Content<DdlDefaultIndentItem> of() {
        return new DdlDefaultIndentItemLoader();
    }
    ...
    public DdlDefaultIndentItem execute() {
        ...
        return DdlDefaultIndentItem.of(
